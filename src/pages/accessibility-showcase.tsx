...
import {
  ...
  AccessibleColorGrid,
} from "@/components/ui/AccessibleColorPalette";
import {
  ContrastDemonstration,
  TextReadabilityDemonstration,
  TextSpacingDemonstration,
} from "@/components/ui/ContrastDemonstration";
...
import {
  AccessibleImage,
  DecorativeImage,
} from "@/components/ui/AccessibleImage";
  ...
  const contrastDemoCombinations = [
    {
      foreground: "#000000",
      background: "#ffffff",
      label: "High Contrast (21:1)",
    },
    {
      foreground: "#6b7280",
      background: "#ffffff",
      label: "Medium Contrast (4.5:1)",
    },
    {
      foreground: "#9ca3af",
      background: "#ffffff",
          ...
          <div className="space-y-8">
            ...
            <section>
              ...
              <div className="prose dark:prose-invert max-w-none">
                <p>
                  This page showcases various accessibility features and
                  components implemented in the Color-Tech project. These
                  components are designed to ensure that the application is
            ...
            <section>
              ...
              <div className="space-y-6">
                <div className="prose dark:prose-invert max-w-none">
                  <p>
                    Color contrast is essential for readability. The WCAG
                    recommends a minimum contrast ratio of 4.5:1 for normal text
            ...
            <section>
              ...
              <AccessibleColorGrid colors={colors} className="mt-6" />
            </section>
            ...
            <section>
              ...
              <div className="prose dark:prose-invert max-w-none mb-4">
                <p>
                  This grid shows the contrast ratios between different color
                  combinations. Click on any cell to see a preview of that color
                  combination.
                </p>
              </div>
              <ColorContrastGrid colors={colors} className="mt-6" />
            </section>
