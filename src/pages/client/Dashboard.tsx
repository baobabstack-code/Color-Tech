        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          {activeBooking ? (
            ...
            <Card className="p-6">
              ...
              <Button className="mt-4" variant="outline" onClick={() => window.location.href = '/booking'}>
                Schedule a Service
              </Button>
            </Card>
          )}
          ...
          <Card className="p-6">
            <div className="flex justify-between items-center mb-4">
              ...
              <Button variant="outline" size="sm" onClick={() => window.location.href = '/client/bookings'}>
                View All
              </Button>
            </div>
        ...
        <div className="space-y-6">
          ...
          <Card className="p-6">
            <div className="flex justify-between items-center mb-4">
              ...
              <Button variant="outline" size="sm" onClick={() => window.location.href = '/client/reviews'}>
                View All
              </Button>
            </div>
          ...
          <Card className="p-6">
            ...
            <div className="space-y-2">
              <Button variant="outline" className="w-full justify-start" onClick={() => window.location.href = '/booking'}>
                <Calendar className="mr-2 h-4 w-4" />
                Schedule a Service
              </Button>
              <Button variant="outline" className="w-full justify-start" onClick={() => window.location.href = '/client/history'}>
                <History className="mr-2 h-4 w-4" />
                Service History
              </Button>
              <Button variant="outline" className="w-full justify-start" onClick={() => window.location.href = '/client/profile'}>
