 ...
 */
export function InteractiveStatesDemonstration({
  className = "",
}: InteractiveStatesDemonstrationProps) {
  return (
      ...
      <div className="space-y-4">
        ...
        <div className="flex flex-wrap gap-8">
          ...
          <div className="space-y-1">
            <a
              href="#"
              className="text-primary-800 dark:text-primary-200 underline"
            >
              Active Link
            </a>
            <p className="text-xs text-gray-500 dark:text-gray-400">Active</p>
          ...
          <div className="space-y-1">
            <a
              href="#"
              className="text-gray-400 dark:text-gray-500 underline pointer-events-none"
            >
              Disabled Link
            </a>
    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="space-y-2">
          <label
            htmlFor="error-input"
            className="text-sm font-medium block text-red-600 dark:text-red-400"
          >
            Error Input
          </label>
          <input
        ...
        <div className="space-y-2">
          <label
            ...
            className="text-sm font-medium block text-gray-500 dark:text-gray-400"
          >
            Disabled Input
          </label>
          <input
