  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <style jsx>{`
        ...
        :global(.settings-form input),
        :global(.settings-form textarea) {
          background-color: rgba(255, 255, 255, 0.1) !important;
          border-color: rgba(255, 255, 255, 0.2) !important;
          color: white !important;
        }
        :global(.settings-form input::placeholder),
        :global(.settings-form textarea::placeholder) {
          color: rgb(156 163 175) !important;
        }
        :global(.settings-form .text-gray-700) {
          color: rgb(209 213 219) !important;
        }
        :global(.settings-form .text-gray-900) {
          color: white !important;
        }
        :global(.settings-form .text-gray-500) {
          color: rgb(156 163 175) !important;
        }
        :global(.settings-form .bg-gray-100) {
          background-color: rgba(255, 255, 255, 0.05) !important;
        }
        :global(.settings-form .border) {
          border-color: rgba(255, 255, 255, 0.2) !important;
        }
        :global(.settings-form .font-medium) {
          color: white !important;
        }
      `}</style>

      <Tabs defaultValue="general" className="w-full settings-form">
        <TabsList className="grid w-full grid-cols-2 md:grid-cols-3 lg:grid-cols-6 bg-white/10 border-white/20">
          <TabsTrigger
            value="general"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    className="mt-1 block w-full h-10 px-1 py-1 border border-gray-300 rounded-md shadow-sm focus:outline-none"
                  />
                </div>
                <div>
                  <label
                  ...
                  <div className="mt-1 flex items-center">
                    ...
                    <span className="ml-3 text-sm text-gray-500">
                      {appearanceSettings.logo?.name || "No file chosen"}
                    </span>
                  </div>
                </div>
              </div>
        ...
        <TabsContent value="booking" className="mt-6">
          <SettingsCard
            ...
            description="Configure booking-related options."
          >
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between p-4 border rounded-md">
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    Enable online payments for your services.
                  </p>
                </div>
                <button
                  type="button"
              ...
              <div className="flex items-center justify-between p-4 border rounded-md">
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    Sync your customer list with Mailchimp.
                  </p>
                </div>
                <button
                  type="button"
