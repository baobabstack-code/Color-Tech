...
function createDatabase() {
    return __awaiter(this, void 0, void 0, function () {
        var dbName, dbUser, dbPassword, dbHost, dbPort, client, checkDbResult, dbClient, schemaPath, schema, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    dbName = process.env.DB_NAME || 'color_tech_db';
                ...
                case 3:
                    checkDbResult = _a.sent();
                    if (!(checkDbResult.rows.length === 0)) return [3 /*break*/, 5];
