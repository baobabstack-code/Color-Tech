...
-- DropForeignKey
ALTER TABLE "public"."posts" DROP CONSTRAINT "posts_createdBy_fkey";

-- DropForeignKey
ALTER TABLE "public"."reviews" DROP CONSTRAINT "reviews_userId_fkey";

-- AlterTable
ALTER TABLE "public"."bookings" ALTER COLUMN "customerId" SET DATA TYPE TEXT;

-- AlterTable
ALTER TABLE "public"."posts" ALTER COLUMN "createdBy" SET DATA TYPE TEXT,
ALTER COLUMN "updatedBy" SET DATA TYPE TEXT;

-- AlterTable
ALTER TABLE "public"."reviews" ALTER COLUMN "userId" SET DATA TYPE TEXT;
